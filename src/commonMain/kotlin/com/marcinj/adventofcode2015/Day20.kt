...
fun runday20() {
    println(" --- Day20 ---")
    val data = 29000000
    println("result for part 1: ${verifyResult(665280, calculateLowestHouseNumber(data, false))}")
    println("result for part 2: ${verifyResult(705600, calculateLowestHouseNumber(data, true))}")
}
