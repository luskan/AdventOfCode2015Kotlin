...
fun runday15() {
    ...
    println(" --- Day15 ---")
    println("result for part 1: ${verifyResult(222870UL, calculateBestCookiesRecipePart1(data))}") // 222870
    println("result for part 2: ${verifyResult(117936UL, calculateBestCookiesRecipePart2(data))}") // 117936
}
