...
fun runday18() {
    ...
    println(" --- Day18 ---")
    println("result for part 1: ${verifyResult(768, calculateNumberOfLightsOn(data, 100, false))}")
    println("result for part 2: ${verifyResult(781, calculateNumberOfLightsOn(data, 100, true))}")
}
