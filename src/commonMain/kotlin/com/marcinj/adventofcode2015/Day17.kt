...
fun runday17() {
    ...
    println("result for part 1: ${verifyResult(1304, calculateNumberOfContainersUsingDynamicProgramming(data, 150).fittingCount)}")
    println("result for part 2: ${verifyResult(18, calculateNumberOfContainers(data, 150).minCount)}")
    println("result for part 2: ${verifyResult(18, calculateNumberOfContainersUsingDynamicProgramming(data, 150).minCount)}")
}
