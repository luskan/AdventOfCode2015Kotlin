...
fun runday16() {
    ...
    println(" --- Day16 ---")
    println("result for part 1: ${verifyResult(373, calculateWhichAuntSuePart(data, false))}")
    println("result for part 2: ${verifyResult(260, calculateWhichAuntSuePart(data, true))}")
}
